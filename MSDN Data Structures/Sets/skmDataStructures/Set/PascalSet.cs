...
namespace skmDataStructures.Set
{
	/// <summary>
	/// Summary description for PascalSet.
	/// </summary>
	public class PascalSet : ICloneable, ICollection
	{
		...
		public virtual PascalSet Intersection(PascalSet s)
		{
			...
			PascalSet result = new PascalSet(this.lowerBound, this.upperBound);
			result.data = this.data.And(s.data);
		...
		public virtual PascalSet Difference(PascalSet s)
		{
			...
			PascalSet result = new PascalSet(this.lowerBound, this.upperBound);
			result.data = this.data.Xor(s.data).And(this.data);
		...
		{			
			return new PascalSetEnumerator(this);
		}
		...
		class PascalSetEnumerator : IEnumerator
		{
			...
			public object Current
			{
				get
				{					
					return position + pSet.lowerBound;
				}
			}
